...
class PrivateBookingSelectionPage extends ConsumerStatefulWidget {
  const PrivateBookingSelectionPage({super.key});

  @override
  ConsumerState<PrivateBookingSelectionPage> createState() => _PrivateBookingSelectionPageState();
}

class _PrivateBookingSelectionPageState extends ConsumerState<PrivateBookingSelectionPage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _buildServiceCard(
    ...
    // Get price - use totalPrice from IntercityServiceType (full vehicle price)
