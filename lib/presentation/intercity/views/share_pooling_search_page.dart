...
class SharePoolingSearchPage extends ConsumerStatefulWidget {
  final String vehicleType;
  const SharePoolingSearchPage({super.key, required this.vehicleType});

  @override
  ConsumerState<SharePoolingSearchPage> createState() => _SharePoolingSearchPageState();
}

class _SharePoolingSearchPageState extends ConsumerState<SharePoolingSearchPage> {
  @override
