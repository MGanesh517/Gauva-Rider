...
class _LocationTextFieldState extends State<LocationTextField> {
  ...
  Widget build(BuildContext context) => AnimatedContainer(
    ...
    decoration: BoxDecoration(
      border: Border.all(
        color: widget.borderColor ?? (isFocused ? ColorPalette.primary50 : ColorPalette.primary95),
        width: 1.w,
      ),
              ...
              Material(
                child: TextFormField(
                  ...
                  style: context.bodyMedium?.copyWith(
                    ...
                    color: widget.textColor ?? context.bodyMedium?.color,
                  ),
                        ...
                        children: [
                          if ((value?.isNotEmpty ?? false) ||
                            ...
                            CupertinoButton(
                              ...
                              child: const Icon(Ionicons.close_circle, size: 18, color: ColorPalette.neutralVariant80),
                            ),
                          Container(width: 1, height: 16, color: ColorPalette.neutral80),
